...
public class ListaPresentacion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lista_presentacion);
        ...
        listaPalabras.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(ListaPresentacion.this, PalabraLayout.class);
    ...
    private void listarDatos() {
        ...
        databaseReference.child("Presentacion").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot objSnapshot:dataSnapshot.getChildren())
                {
                    ...
                    arrayAdapterPalabra = new ArrayAdapter<Palabra>(ListaPresentacion.this,android.R.layout.simple_list_item_1, listPalabra);
