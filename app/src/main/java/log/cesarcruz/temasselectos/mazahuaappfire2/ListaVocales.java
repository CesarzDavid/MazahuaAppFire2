...
public class ListaVocales extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lista_vocales);
        //////////////////////////////////////////
        ...
        listaPalabras.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(ListaVocales.this, PalabraLayout.class);
    ...
    private void listarDatos() {
        ...
        databaseReference.child("Vocales").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot objSnapshot:dataSnapshot.getChildren())
                {
                    ...
                    arrayAdapterPalabra = new ArrayAdapter<Palabra>(ListaVocales.this,android.R.layout.simple_list_item_1, listPalabra);
