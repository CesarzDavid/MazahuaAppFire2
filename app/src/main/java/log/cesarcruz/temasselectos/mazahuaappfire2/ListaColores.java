...
public class ListaColores extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listaPalabras.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(ListaColores.this, PalabraLayout.class);
    ...
    private void listarDatos() {
        ...
        databaseReference.child("Colores").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot objSnapshot:dataSnapshot.getChildren())
                {
                    ...
                    arrayAdapterPalabra = new ArrayAdapter<Palabra>(ListaColores.this,android.R.layout.simple_list_item_1, listPalabra);
