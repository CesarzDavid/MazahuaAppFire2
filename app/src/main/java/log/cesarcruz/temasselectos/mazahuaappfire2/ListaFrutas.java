    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listaPalabras.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(ListaFrutas.this, PalabraLayout.class);
        ...
        databaseReference.child("Frutas").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot objSnapshot:dataSnapshot.getChildren())
                {
                    ...
                    arrayAdapterPalabra = new ArrayAdapter<Palabra>(ListaFrutas.this,android.R.layout.simple_list_item_1, listPalabra);
